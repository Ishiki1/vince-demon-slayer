# Dry-run: iter_008 — case_03 — Stone Golem (goon-generator skill only)

**Iteration 8 change:** **Idle** and **attack** templates add a **compositional anchor**: *"The viewer sees the creature from a side-profile view showing its LEFT flank -- the creature's head points left and its tail/back faces right."* **Frame 1** idle adds **LEFT flank visible to viewer**. This fixes viewpoint for heavy silhouettes and slam arcs. **Iteration 7** vertical-slam example and prior guidance are otherwise unchanged.
...
<!-- SCORES
{
  ...
  "reasoning": {
    "Attack Animation Quality": "+1 vs iter_007: fixed side-profile staging helps overhead → down-left slam read without ambiguous three-quarter flips.",
    "Facing Direction Enforcement": "+6 vs iter_007: compositional flank anchor adds a prevention layer before gates fire.",
    "Green Cleanup Verification": "Unchanged vs iter_007.",
    "Frame Count Adequacy": "Unchanged vs iter_007 at 68.",
    "Phase Completeness": "Unchanged vs iter_007 at 75.",
    "Prompt Adaptability": "Unchanged vs iter_007 at 68."
  }
}
-->

**Weighted case score (AAQ 25%, FDE 20%, GCV 20%, FCA 15%, PC 10%, PA 10%):**  
79×0.25 + 76×0.20 + 63×0.20 + 68×0.15 + 75×0.10 + 68×0.10 = 19.75 + 15.2 + 12.6 + 10.2 + 7.5 + 6.8 = **72.05**
