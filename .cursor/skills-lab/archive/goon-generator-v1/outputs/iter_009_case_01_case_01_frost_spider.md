# Dry-run: iter_009 — case_01 — Frost Spider (goon-generator skill only)

**Iteration 9 change:** **Phase 6** adds an **Outline integrity check** subsection immediately **after** the green residue verification: **dark bodies** that could merge with the **black outline** — **inspect idle frame 1** for a **visible black outer border**; **thin legs/antennae** — after aggressive cleanup, verify **thin extremities still show black outline**; **remediation** — **lower cleanup threshold to 24 or 20** and reprocess, with an explicit trade-off between **green residue risk** and **outline preservation**. **Iteration 8** LEFT-flank compositional anchor on idle/attack templates and **iterations 0–7** guidance (motion arcs, frame counts, adaptations, facing gates, negatives) are otherwise unchanged.
...
<!-- SCORES
{
  "scores": {
    ...
    "Green Cleanup Verification": 74,
    "Frame Count Adequacy": 70,
    "Phase Completeness": 80,
    "Prompt Adaptability": 68
  },
  "reasoning": {
    "Attack Animation Quality": "Unchanged vs iter_008 at 79.",
    "Facing Direction Enforcement": "Unchanged vs iter_008 at 76.",
    "Green Cleanup Verification": "+6 vs iter_008: Phase 6 outline check targets **thin extremities** — explicit verify that legs/antennae keep **black outline** after cleanup, plus threshold 24/20 remediation and residue trade-off.",
    "Frame Count Adequacy": "Unchanged vs iter_008 at 70.",
    "Phase Completeness": "Unchanged vs iter_008 at 80; outline check extends Phase 6, not a skipped phase.",
    "Prompt Adaptability": "+1 vs iter_008: thin-feature outline verification directly addresses spider/insect-class edge cases named in adaptations."
  }
}
-->

**Weighted case score (AAQ 25%, FDE 20%, GCV 20%, FCA 15%, PC 10%, PA 10%):**  
79×0.25 + 76×0.20 + 74×0.20 + 70×0.15 + 80×0.10 + 68×0.10 = 19.75 + 15.2 + 14.8 + 10.5 + 8 + 6.8 = **75.05**
