# Dry-run: iter_004 — case_02 — Goblin Shaman (goon-generator skill only)
...
<!-- SCORES
{
  ...
  "reasoning": {
    "Attack Animation Quality": "+4 vs iter_3: cast reads in more steps (channel → release → dissipate); smoother than six-frame squeeze.",
    "Facing Direction Enforcement": "Unchanged from iter_3; bolt-left still maps cleanly to criterion 2; frame index updates only.",
    "Green Cleanup Verification": "Unchanged from iter_3; green-skinned goblin still uses Phase 6 halo inspection path.",
    "Frame Count Adequacy": "+20 vs iter_3: duration and granularity improved; still no model-quality trade-offs or optional longer arcs for complex casts.",
    "Phase Completeness": "Unchanged phase list; attack spec and timing note expanded.",
    "Prompt Adaptability": "Unchanged from iter_3; staff asymmetry and interior green still need human judgment."
  }
}
-->

**Weighted case score (AAQ 25%, FDE 20%, GCV 20%, FCA 15%, PC 10%, PA 10%):**  
72×0.25 + 70×0.20 + 70×0.20 + 55×0.15 + 80×0.10 + 40×0.10 = 18 + 14 + 14 + 8.25 + 8 + 4 = **66.25**
