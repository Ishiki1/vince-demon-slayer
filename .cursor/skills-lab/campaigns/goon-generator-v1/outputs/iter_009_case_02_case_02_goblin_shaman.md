# Dry-run: iter_009 — case_02 — Goblin Shaman (goon-generator skill only)

**Iteration 9 change:** **Phase 6** adds an **Outline integrity check** after green residue: **dark-body/outline merge** — **inspect idle frame 1** for a **visible black outer border**; **thin features** (fingers, ears, staff filigree) — verify **extremities retain black outline** after aggressive cleanup; **remediation** — **threshold 24 or 20** and reprocess, noting **green residue vs outline preservation**. **Iteration 8** LEFT-flank compositional anchor and **iterations 0–7** pipeline guidance are otherwise unchanged.
...
<!-- SCORES
{
  ...
  "reasoning": {
    ...
    "Green Cleanup Verification": "+2 vs iter_008: outline check still sharpens post-clean verification (frame-1 border, thin-feature outlines, 24/20 remediation) even though **green skin** remains the dominant cleanup concern; small lift vs spider/golem.",
    "Frame Count Adequacy": "Unchanged vs iter_008 at 70.",
    "Phase Completeness": "Unchanged vs iter_008 at 80.",
    "Prompt Adaptability": "Unchanged vs iter_008 at 67; shaman’s primary edge case stays green-merge, not outline-first."
  }
}
-->

**Weighted case score (AAQ 25%, FDE 20%, GCV 20%, FCA 15%, PC 10%, PA 10%):**  
79×0.25 + 76×0.20 + 75×0.20 + 70×0.15 + 80×0.10 + 67×0.10 = 19.75 + 15.2 + 15 + 10.5 + 8 + 6.7 = **75.15**
