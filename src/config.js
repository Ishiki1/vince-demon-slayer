...
const CONFIG = {
  ...
  // Combat scene layout
  COMBAT_HERO_X: 150,
  COMBAT_ROW_Y_OFFSET: 100,
  COMBAT_ENEMY_GAP: 20,
  COMBAT_ENEMY_BOSS_GAP: 50,
  COMBAT_SINGLE_OFFSET: 70,
  COMBAT_BAR_X: 20,
  COMBAT_BAR_Y: 20,
  COMBAT_BAR_WIDTH: 200,
  COMBAT_BAR_HEIGHT: 20,
  COMBAT_BAR_MANA_Y: 42,
  COMBAT_BAR_XP_Y: 64,
  COMBAT_STATUS_Y: 88,
  COMBAT_LOG_WIDTH: 210,
  COMBAT_LOG_OFFSET_X: 220,
  COMBAT_LABEL_OFFSET_NAME: 28,
  COMBAT_LABEL_OFFSET_HP: 12,
};
