...
- **Event** uses `EventScene-bg.png` (1536x1024 source, stretched to 800x600). Approval proof manifest `EventScene-bg-text-layout-800x600.json` marks the recommended safe text zones: title `195,106 410x32`, body `150,148 500x72`, result `150,226 500x48`. Prefer a `500px` wrap width and top-anchored text so longer event copy grows downward instead of upward into the frame.
